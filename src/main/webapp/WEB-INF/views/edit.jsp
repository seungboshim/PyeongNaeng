...
<div class="wrapper">
    ...
    <form class="formWrapper" method="post">
        <div class="form">
            <div class="formInput">
                <span>식당 이름</span>
                <input type="text" name="name" value="${restaurant.name}" placeholder="식당 이름을 입력해주세요." required />
            </div>
            <div class="formInput">
                <span>식당 주소</span>
                <input type="text" name="address" value="${restaurant.address}" placeholder="식당 주소를 입력해주세요." />
            </div>
            <div class="formInput">
                <span>평냉의 맛</span>
                <input type="text" name="taste" value="${restaurant.taste}" placeholder="평냉의 맛을 쉼표를 구분자로 작성해주세요." />
            </div>
            <div class="formInput">
                <span>평냉 가격</span>
